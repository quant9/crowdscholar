...
class Scholarship(db.Model):
    ...
    grade_12 = db.Column(db.Boolean, default=False)
    undergrad_not_enrolled = db.Column(db.Boolean, default=False)
    undergrad_enrolled = db.Column(db.Boolean, default=False)
    postgrad_not_enrolled = db.Column(db.Boolean, default=False)
    postgrad_enrolled = db.Column(db.Boolean, default=False)
